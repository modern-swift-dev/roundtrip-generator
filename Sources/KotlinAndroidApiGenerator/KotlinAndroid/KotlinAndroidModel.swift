...
struct KotlinAndroidDataClass: Node {
    var name: String
    var properties: [KotlinAndroidProperty]
    ...
    init(
        name: String,
        properties: [KotlinAndroidProperty],
        annotations: [String] = [],
        interfaces: [String] = [],
...
private func kotlinEqualsFunction(className: String, properties: [KotlinAndroidProperty]) -> String {
    Block {
...
private func kotlinHashCodeFunction(properties: [KotlinAndroidProperty]) -> String {
...
struct KotlinAndroidEnumCase: Hashable {
    var name: String
...
struct KotlinAndroidEnumClass: Node {
    var name: String
    var cases: [KotlinAndroidEnumCase]
    var rawValuePropertyName: String?
    var rawValueType: KotlinAndroidTypeName?
    var annotations: [String]
    var interfaces: [String]
    ...
    init(
        name: String,
        cases: [KotlinAndroidEnumCase],
        rawValuePropertyName: String? = nil,
        rawValueType: KotlinAndroidTypeName? = nil,
        annotations: [String] = [],
        interfaces: [String] = [],
        functions: [String] = [],
        includeGeneratedComment: Bool = true,
