...
extension ApiParameter.DataType {
    ...
    func kotlinOperationTypeDeclaration(options: KotlinAndroidGeneratorOptions) -> String {
        switch self {
            case .bool:
                "Boolean"
            case .boolArray:
    ...
    func kotlinOperationDefaultValue(options: KotlinAndroidGeneratorOptions) -> String? {
        switch self {
            case let .bool(value):
    ...
    var isKotlinAndroidOperationCollection: Bool {
        switch self {
            case .boolArray,
                 .stringArray,
                 .intArray,
