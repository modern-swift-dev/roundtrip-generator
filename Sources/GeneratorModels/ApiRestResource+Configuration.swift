...
public extension Array where Element == ApiRestResource.Operation {
    /// List and retrieve operations, with paged list responses.
    static var readOnly: Self { [.list(), .retrieve] }

    /// The standard create, update, patch, delete, list, and retrieve operations.
    static var crud: Self { [.create, .update, .patch, .delete, .list(), .retrieve] }
}
