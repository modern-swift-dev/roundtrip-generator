...
public extension ShowcaseSampleModelsApi {
    struct PrimitiveMatrix: Codable, Sendable, Equatable, Hashable {
        ...
        public init(
            ...
            aliases: [String],
            steps: [Int],
            visibility: ShowcaseApi.SampleVisibility,
            score: SampleScore,
            audit: AuditStamp,
            related: [NamedObject],
        ...
        public static func == (lhs: PrimitiveMatrix, rhs: PrimitiveMatrix) -> Bool {
            lhs.uuid == rhs.uuid
        }
