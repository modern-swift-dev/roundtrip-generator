    ...
    struct ListOperation: Sendable {
        public struct Request: URLRequestConvertible, Equatable, Sendable {
            ...
            public var requestPath: String {
                ...
                var path = "/project/{project_id}/task"
            ...
            public var queryParameters: [String: any FormEncodable] {
                ...
                if let __api0DoneValue = self.done {
                    values["done"] = String(describing: __api0DoneValue)
                }
                return values
            }

            public init(tenantId: String, projectId: String, done: Bool? = nil) {
        ...
        public typealias Response = PagedResults<IdentifiedTask>
    }
}
