...
public enum GeneratedRequestValueParser {
    ...
    public static func optional<T: LosslessStringConvertible>(_ value: String?, name: String, as _: T.Type) throws -> T? {
    ...
    public static func requiredArray<T: LosslessStringConvertible>(_ value: String?, name: String, as _: T.Type) throws -> [T] {
    ...
    public static func requiredStringRawEnumArray<T: RawRepresentable>(_ value: String?, name: String, as _: T.Type) throws -> [T] where T.RawValue == String {
    ...
    public static func requiredIntRawEnumArray<T: RawRepresentable>(_ value: String?, name: String, as _: T.Type) throws -> [T] where T.RawValue == Int {
        try requiredStringArray(value, name: name).map { raw in
...
public extension KeyedDecodingContainer {
    func decodePatchable<Value: Codable>(
        ...
        return try .value(decode(Value.self, forKey: key))
    }
}
...
public enum GeneratedJSONValue: Codable, Sendable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if container.decodeNil() {
            ...
            self = try .object(container.decode([String: GeneratedJSONValue].self))
        }
    }
