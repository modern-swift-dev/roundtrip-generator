...
@Suite(.serialized) struct KotlinSpringBootGeneratorTests {
    ...
    @Test func `generated spring enum raw value collisions fail validation`() {
    ...
    @Test func `generated spring reference validation matches swift client`() {
    ...
    @Test func `generated spring name and file path collisions fail validation`() throws {
    ...
    @Test func `spring path placeholder validation only checks routable relative operations`() {
    ...
    @Test func `spring acceptable statuses validation matches body rules`() {
    ...
    @Test func `spring operation parameter validation matches client rules`() {
    ...
    @Test func `spring multipart parts fail validation when generated parameters are invalid`() {
    ...
    @Test func `generated project includes gradle runtime controllers services requests and models`() throws {
    ...
    @Test func `generated spring gradle files escape kotlin strings`() throws {
        let options = KotlinSpringBootGeneratorOptions(
    ...
    @Test func `spring route literals ignore static query and fragment`() throws {
        let operation = ApiOperation.get(
            name: "search",
    ...
    @Test func `generated controllers cover supported request and response shapes`() throws {
        let files = try KotlinSpringBootApiPackageGenerator(package: testPackage()).generatedFiles()
        let output = files.map(\.contents).joined(separator: "\n")
    ...
    @Test func `generated spring json nil request does not consume json`() throws {
    ...
    @Test func `generated spring preserves required non auth api key default`() throws {
        let operation = ApiOperation.get(
            name: "search",
            path: .relative("/items"),
            security: .unsecured,
    ...
    @Test func `generated controller wraps parameter parse failures as bad request`() throws {
    ...
    @Test func `generated controller indents multiline parameter defaults`() throws {
        let operation = ApiOperation.get(
            name: "search",
            path: .relative("/items"),
            security: .unsecured,
    ...
    @Test func `spring generator filters unsupported absolute and runtime operations`() throws {
        let user = ApiTypeSchema.object(typeName: "User", properties: [.string("name")])
    ...
    @Test func `spring generator does not validate skipped operation types`() throws {
        let user = ApiTypeSchema.object(typeName: "User", properties: [.string("name")])
    ...
    @Test func `spring referenced modules mirror swift aggregate without source emission`() throws {
    ...
    @Test func `generated spring models use scoped packages and kotlinx serialization`() throws {
        let files = try KotlinSpringBootApiPackageGenerator(package: testPackage()).generatedFiles()
    ...
    @Test func `generated spring identifiable models use runtime interface`() throws {
    ...
    @Test func `generated spring identifiable uses nullable ID type when ID is optional`() throws {
        let user = ApiTypeSchema.object(
            typeName: "User",
            properties: [
    ...
    @Test func `generated spring runtime does not mutate response headers for content type`() {
    ...
    @Test func `generated spring sanitizes package segments with leading digits`() throws {
        let user = ApiTypeSchema.object(
            typeName: "User",
            properties: [.string("name")],
        )
    ...
    @Test func `generated spring sanitizes keyword package segments`() throws {
        let operation = ApiOperation.get(
            name: "get",
            path: .relative("/users"),
            security: .unsecured,
    ...
    @Test func `generated spring empty object uses regular class`() throws {
    ...
    @Test func `dynamic objects use configured payload serial name`() throws {
    ...
    @Test func `generated spring omits unpublished object fields`() throws {
    ...
    @Test func `generated spring models and requests use content equality for binary fields`() throws {
    ...
    @Test func `mapped enum parameter default uses mapped type name`() throws {
        let visibility = ApiTypeSchema.stringEnum(
            typeName: "Visibility",
            values: [
                (name: "Public", rawName: "public"),
    ...
    @Test func `mapped enum model default does not use original type`() throws {
        let visibility = ApiTypeSchema.stringEnum(
            typeName: "Visibility",
            values: [
                (name: "Public", rawName: "public"),
    ...
    @Test func `mapped object ignores internal external references`() throws {
    ...
    @Test func `common references resolve without generating spring models`() throws {
