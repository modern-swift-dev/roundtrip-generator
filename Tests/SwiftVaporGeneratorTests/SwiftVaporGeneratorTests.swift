...
@Suite(.serialized) struct SwiftVaporGeneratorTests {
    @Test func `options expose defaults`() {
    ...
    @Test func `generated project includes manifest runtime routes and services`() throws {
    ...
    @Test func `generated manifest includes additional dependencies`() throws {
    ...
    @Test func `vapor generator rejects apple only imports`() throws {
    ...
    @Test func `vapor generator allows foundation imports`() throws {
    ...
    @Test func `custom module name controls manifest and source paths`() throws {
    ...
    @Test func `generated manifest omits run target when disabled`() throws {
        let files = try SwiftVaporApiPackageGenerator(
            package: testPackage(),
    ...
    @Test func `operation imports are emitted in route files`() throws {
        let externalType = ApiTypeSchema.reference(
    ...
    @Test func `package imports are emitted in vapor files`() throws {
    ...
    @Test func `common references resolve without generating vapor models`() throws {
    ...
    @Test func `supplied dotted reference keeps qualified vapor type name`() throws {
    ...
    @Test func `referenced modules are not generated as vapor routes`() throws {
    ...
    @Test func `class models preserve reference semantics and drop implicit sendable`() throws {
    ...
    @Test func `generated routes cover supported request and response shapes`() throws {
        let files = try SwiftVaporApiPackageGenerator(package: testPackage()).generatedFiles()
        let output = files.map(\.contents).joined(separator: "\n")
    ...
    @Test func `route literals use explicit path components`() throws {
        let operation = ApiOperation.get(
            name: "lookup",
    ...
    @Test func `enum parameter defaults use declared cases`() throws {
    ...
    @Test func `typed json responses keep declared bodyless statuses for encoding`() throws {
    ...
    @Test func `absolute operation paths are skipped for backend routes`() throws {
        let package = ApiPackage(
            name: "Test",
            targetDirUrl: FileManager.default.temporaryDirectory.appendingPathComponent(UUID().uuidString, isDirectory: true),
            modules: [
    ...
    @Test func `required user api key parameter keeps default value`() throws {
        let operation = ApiOperation.get(
            name: "lookup",
    ...
    @Test func `generated runtime uses string dates and shared wrapper shapes`() throws {
    ...
    @Test func `object models preserve imports defaults and identity conformance`() throws {
    ...
    @Test func `negative int enum cases use valid swift identifiers`() throws {
        let score = ApiTypeSchema.intEnum(
            typeName: "Score",
            values: [
                (name: nil, rawValue: -1),
    ...
    @Test func `secured routes authorize before decoding request values`() throws {
        let controller = try #require(
            SwiftVaporApiPackageGenerator(package: testPackage()).generatedFiles().first {
    ...
    @Test func `patchable request models decode missing null and value distinctly`() throws {
    ...
    @Test func `dynamic object requests responses use typed enums`() throws {
    ...
    @Test func `dynamic object equality uses associated values when supported`() throws {
        let payload = ApiTypeSchema.object(
            typeName: "Payload",
            properties: [
    ...
    @Test func `route handlers avoid reserved local name collisions`() throws {
        let operation = ApiOperation.get(
            name: "lookup",
            path: .relative("/lookup"),
            security: .unsecured,
    ...
    @Test func `date parameters use foundation dates`() throws {
        let operation = ApiOperation.get(
            name: "search",
    ...
    @Test func `object encoding qualifies property names that collide with locals`() throws {
    ...
    @Test func `dynamic object garbage does not require extra properties`() throws {
        let payload = ApiTypeSchema.object(
            typeName: "Payload",
            properties: [
                .uuid("id", equatable: true, hashable: true)
    ...
    @Test func `invalid package names are rejected before manifest emission`() throws {
    ...
    @Test func `invalid module names are rejected before manifest emission`() throws {
    ...
    @Test func `typed bodyless json responses are rejected`() {
    ...
    @Test func `binary bodyless responses are rejected`() {
        let operation = ApiOperation(
            name: "emptyBinary",
            method: .get,
            path: .relative("/empty"),
    ...
    @Test func `skipped operation types are not validated or generated`() throws {
    ...
    @Test func `route literals ignore static query and fragment`() throws {
        let operation = ApiOperation.get(
            name: "search",
    ...
    @Test func `duplicate flat vapor generated paths are rejected`() {
    ...
    @Test func `duplicate vapor routes are rejected`() {
    ...
    @Test func `duplicate vapor multipart generated properties are rejected`() {
    ...
    @Test func `stale cleanup only removes vapor managed sources`() throws {
    ...
    @Test func `stale cleanup removes old module managed sources`() throws {
        let directory = FileManager.default.temporaryDirectory.appendingPathComponent(UUID().uuidString, isDirectory: true)
        try FileManager.default.createDirectory(at: directory, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: directory) }
    ...
    @Test func `write refuses user owned files`() throws {
        let directory = FileManager.default.temporaryDirectory.appendingPathComponent(UUID().uuidString, isDirectory: true)
        try FileManager.default.createDirectory(at: directory, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: directory) }
    ...
    @Test func `write refuses user owned dockerfile`() throws {
        let directory = FileManager.default.temporaryDirectory.appendingPathComponent(UUID().uuidString, isDirectory: true)
        try FileManager.default.createDirectory(at: directory, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: directory) }
