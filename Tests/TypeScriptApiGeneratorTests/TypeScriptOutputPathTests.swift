...
struct TypeScriptOutputPathTests {
    ...
    func `custom directory has consistent entry points`(directory: String) throws {
    ...
    func `custom directory compiles`(directory: String) throws {
    ...
    func `rejects colliding or non canonical directories`(directory: String) {
        let package = ApiPackage(name: "Example", targetDirUrl: URL(fileURLWithPath: "/unused"), modules: [], referencedModules: [], references: [], commonReferences: [], imports: [])
