...
@Suite(.serialized) struct OpenApiYamlGeneratorTests {
    @Test func sharedReferenceGraphsRegisterEachSchemaOnce() {
        let depth = 24
    ...
    @Test func deeplyNestedModelsRegisterEachSchema() {
    ...
    @Test func generatedYamlContainsPathsSchemasBodiesAndSecurity() throws {
    ...
    @Test func generatedYamlIncludesRuntimeMultipartBinaryCookieAndExternalReferences() {
    ...
    @Test func writeRefusesToOverwriteUserOwnedFile() throws {
