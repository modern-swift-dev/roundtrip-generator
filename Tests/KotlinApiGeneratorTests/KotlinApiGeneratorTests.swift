...
@Suite(.serialized) struct KotlinApiGeneratorTests {
    @Test func optionsExposeGradleAndKtlintDefaults() {
    ...
    @Test func generatedProjectIncludesGradleEditorConfigAndKtlint() throws {
    ...
    @Test func generatedKotlinGradleFilesEscapeKotlinStrings() throws {
        let options = KotlinGeneratorOptions(
    ...
    @Test func generatedKotlinContainsModelOperationServiceRuntimeAndKoin() throws {
        let files = try KotlinApiPackageGenerator(package: testPackage()).generatedFiles()
    ...
    @Test func generatedKotlinOmitsUnpublishedObjectFields() throws {
    ...
    @Test func generatedKotlinModelsUseContentEqualityForBinaryFields() throws {
    ...
    @Test func generatedKotlinUsesScopedPackagesAndImports() throws {
        let files = try KotlinApiPackageGenerator(package: testPackage()).generatedFiles()
    ...
    @Test func generatedKotlinIdentifiableUsesNullableIDTypeWhenIDIsOptional() throws {
    ...
    @Test func generatedKotlinSanitizesPackageSegmentsWithLeadingDigits() throws {
        let user = ApiTypeSchema.object(
            typeName: "User",
    ...
    @Test func generatedKotlinSanitizesKeywordPackageSegments() throws {
        let operation = ApiOperation.get(
            name: "get",
            path: .relative("/users"),
            security: .unsecured
    ...
    @Test func generatedKotlinReusesSharedModelDeclarations() throws {
    ...
    @Test func generatedKotlinSkipsMappedModelDeclarations() throws {
    ...
    @Test func generatedKotlinEmptyObjectUsesRegularClass() throws {
    ...
    @Test func generatedKotlinPatchableFieldsAreNonNullableWithUnmodifiedDefault() throws {
    ...
    @Test func generatedKotlinRespectsGenerateApiModulesFlag() throws {
        let package = ApiPackage(
            name: "Test",
            targetDirUrl: FileManager.default.temporaryDirectory.appendingPathComponent(UUID().uuidString, isDirectory: true),
            modules: [
    ...
    @Test func generatedKotlinSkipsApiModulesWhenNoDefinitionsExist() throws {
        let package = ApiPackage(
            name: "Test",
            targetDirUrl: FileManager.default.temporaryDirectory.appendingPathComponent(UUID().uuidString, isDirectory: true),
            modules: [],
    ...
    @Test func kotlinApiMocksEmitterBuildsMockApisAndModules() {
    ...
    @Test func kotlinApiMocksEmitterImportsSharedModelsFromRealPackage() {
    ...
    @Test func generatedKotlinReferencedModulesMirrorSwiftAggregateWithoutSourceEmission() throws {
    ...
    @Test func generatedKotlinRecognizesCommonReferencesWithoutEmittingThem() throws {
    ...
    @Test func generatedKotlinValidationIgnoresReferencedModuleExternalTypes() throws {
    ...
    @Test func generatedKotlinJsonNilRequestDoesNotSendContentType() throws {
    ...
    @Test func generatedKotlinMappedEnumModelDefaultDoesNotUseOriginalType() throws {
        let visibility = ApiTypeSchema.stringEnum(
            typeName: "Visibility",
            values: [
                (name: "Public", rawName: "public"),
    ...
    @Test func generatedKotlinMappedObjectIgnoresInternalExternalReferences() throws {
        let mappedThing = ApiTypeSchema.object(
            typeName: "MappedThing",
            properties: [
    ...
    @Test func standaloneGradleProjectFilesCanBeWrittenTwice() throws {
        let targetDirURL = FileManager.default.temporaryDirectory.appendingPathComponent(UUID().uuidString, isDirectory: true)
        try FileManager.default.createDirectory(at: targetDirURL, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: targetDirURL) }
    ...
    @Test func serviceImportsPrimitiveResponseTypes() throws {
    ...
    @Test func pagedResultsGetNextPageUsesNextUrlHeadersSecurityAndStatuses() throws {
        let operation = ApiOperation.get(
            name: "list",
            path: .relative("/users"),
            security: .optional,
    ...
    @Test func enumParametersUseRawValuesForFormAndPathValues() throws {
        let visibility = ApiTypeSchema.stringEnum(
            typeName: "Visibility",
            values: [
                (name: "public", rawName: "public"),
    ...
    @Test func requiredCollectionParametersAreAlwaysEmitted() throws {
        let operation = ApiOperation.get(
            name: "search",
            path: .relative("/search"),
            security: .unsecured,
    ...
    @Test func onlyGeneratedAuthorizationApiKeyIsNullableAndBlankFiltered() throws {
        let operation = ApiOperation.post(
            name: "lookup",
            path: .relative("/lookup"),
            security: .unsecured,
    ...
    @Test func operationExtraImportsAreEmitted() throws {
        let operation = ApiOperation.get(
            name: "lookup",
            path: .relative("/lookup"),
            security: .unsecured,
    ...
    @Test func progressOverridesDoNotRepeatDefaultValue() throws {
    ...
    @Test func binaryRequestsUseSwiftClientExecuteShapeAndContentEquality() throws {
        let operation = ApiOperation.post(
            name: "uploadBinary",
            path: .relative("/upload"),
            security: .unsecured,
    ...
    @Test func multipartRequestsUseDedicatedBodyType() throws {
        let operation = ApiOperation.postMultipart(
            name: "upload",
            path: .relative("/upload"),
            security: .unsecured,
    ...
    @Test func jsonMapRequestBodiesDoNotUseMultipartRuntimeBranch() throws {
        let operation = ApiOperation.post(
            name: "updateLabels",
    ...
    @Test func jsonRequestBodiesCarryStaticKtorTypeInfo() throws {
    ...
    @Test func generatedKtorRuntimeWiresUploadProgress() {
    ...
    @Test func generatedKtorRuntimeAlwaysSetsMultipartContentDisposition() {
        let runtime = KotlinRuntimeEmitter().kotlinCode(packageName: "com.example.api").toString()
    ...
    @Test func generatedKtorRuntimeUsesContentEqualityForBinaryContainers() {
        let runtime = KotlinRuntimeEmitter().kotlinCode(packageName: "com.example.api").toString()
    ...
    @Test func generatedKtorRuntimeFiltersAuthAndPreservesExplicitAccept() {
        let runtime = KotlinRuntimeEmitter().kotlinCode(packageName: "com.example.api").toString()
    ...
    @Test func generatedKtorRuntimeCarriesSwiftResponseConvenienceMetadata() {
        let runtime = KotlinRuntimeEmitter().kotlinCode(packageName: "com.example.api").toString()
    ...
    @Test func generatedKtorPagedResultsCarriesCountAndHasNext() {
        let runtime = KotlinRuntimeEmitter().kotlinCode(packageName: "com.example.api").toString()
    ...
    @Test func generatedKtorRuntimeCarriesResponseMimeAndBinarySerializer() {
        let runtime = KotlinRuntimeEmitter().kotlinCode(packageName: "com.example.api").toString()
    ...
    @Test func generatedKtorRuntimePreservesDateTimeParameterFractions() {
        let runtime = KotlinRuntimeEmitter().kotlinCode(packageName: "com.example.api").toString()
    ...
    @Test func generatedKtorRuntimeEscapesMultipartHeaderValues() {
        let runtime = KotlinRuntimeEmitter().kotlinCode(packageName: "com.example.api").toString()
    ...
    @Test func generatedKtorRuntimeExposesMultipartPartHelpers() {
        let runtime = KotlinRuntimeEmitter().kotlinCode(packageName: "com.example.api").toString()
    ...
    @Test func generatedKtorRuntimeEncodesJsonByteArrayAsBase64String() {
        let runtime = KotlinRuntimeEmitter().kotlinCode(packageName: "com.example.api").toString()
    ...
    @Test func generatedKtorRuntimeEncodesPathSegmentsFromUtf8Bytes() {
        let runtime = KotlinRuntimeEmitter().kotlinCode(packageName: "com.example.api").toString()
    ...
    @Test func unsecuredServiceMethodsUseRequestDirectly() throws {
    ...
    @Test func mappedOperationImportsUseGeneratorOptions() throws {
    ...
    @Test func mappedOperationDefaultsUseGeneratorOptions() throws {
        let mappedStatus = ApiTypeSchema.reference(typeName: "MappedStatus", strict: false, imports: ["Foundation"])
        let operation = ApiOperation.get(
            name: "search",
            path: .relative("/search"),
    ...
    @Test func generatedKotlinNameCollisionsFailValidation() {
    ...
    @Test func generatedKotlinReferenceValidationMatchesSwiftClient() {
    ...
    @Test func generatedKotlinPackageCollisionsFailValidation() {
    ...
    @Test func invalidOperationShapesFailBeforeGeneratingBrokenKotlinClient() {
