...
@Suite(.serialized) struct KotlinAndroidApiGeneratorTests {
    ...
    @Test func `generated kotlin android omits unpublished object fields`() throws {
    ...
    @Test func `generated kotlin android models use content equality for binary fields`() throws {
    ...
    @Test func `generated kotlin android identifiable uses nullable ID type when ID is optional`() throws {
    ...
    @Test func `generated kotlin android sanitizes package segments with leading digits`() throws {
        let user = ApiTypeSchema.object(
            typeName: "User",
    ...
    @Test func `generated kotlin android sanitizes keyword package segments`() throws {
        let operation = ApiOperation.get(
            name: "get",
            path: .relative("/users"),
            security: .unsecured,
    ...
    @Test func `generated kotlin android reuses shared model declarations`() throws {
    ...
    @Test func `generated kotlin android skips mapped model declarations`() throws {
    ...
    @Test func `generated kotlin android empty object uses regular class`() throws {
    ...
    @Test func `generated kotlin android patchable fields are non nullable with unmodified default`() throws {
    ...
    @Test func `generated kotlin android recognizes common references without emitting them`() throws {
    ...
    @Test func `generated kotlin android validation ignores referenced module external types`() throws {
    ...
    @Test func `generated kotlin android mapped enum model default does not use original type`() throws {
        let visibility = ApiTypeSchema.stringEnum(
            typeName: "Visibility",
            values: [
                (name: "Public", rawName: "public"),
    ...
    @Test func `generated kotlin android mapped object ignores internal external references`() throws {
        let mappedThing = ApiTypeSchema.object(
            typeName: "MappedThing",
            properties: [
    ...
    @Test func `write removes stale managed kotlin android sources`() throws {
    ...
    @Test func `generated kotlin android name collisions fail validation`() {
    ...
    @Test func `generated kotlin android reference validation matches swift client`() {
    ...
    @Test func `generated kotlin android package collisions fail validation`() {
    ...
    @Test func `invalid operation shapes fail before generating broken kotlin android client`() {
    ...
    @Test func `android defaults and project are native`() throws {
        ...
        #expect(try files == (generator.generatedFiles()))
    ...
    @Test func `android optional outputs and named service parameters`() throws {
        let files = try KotlinAndroidApiPackageGenerator(
            package: testPackage(),
    ...
    @Test func `android manifest can be regenerated and user files stay protected`() throws {
